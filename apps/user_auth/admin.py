...
class AsUserLevel1CheckModelAdmin(admin.ModelAdmin):
    list_display = ['user', 'first_name', 'last_name', 'father_name', 'national_code', 'phone_number', 'uuid', 'is_accepted', 'created_at']


@admin.register(AsUserLevel2CheckModel)
class AsUserLevel2CheckModelAdmin(admin.ModelAdmin):
    list_display = ['user', 'authentication_image', 'uuid', 'is_accepted', 'created_at']